      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            mentorsDetailsResponse
                        ?.data?.instructor?.about?.experiences?.length !=
                    0
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      mentorsDetailsResponse?.data?.instructor?.about
                                  ?.experiences?[0].description?.isNotEmpty ==
                              true
                          ? CustomText(
                              text: mentorsDetailsResponse?.data?.instructor
                                      ?.about?.experiences?[0].description ??
                                  '',
                              fontSize: 14.sp,
