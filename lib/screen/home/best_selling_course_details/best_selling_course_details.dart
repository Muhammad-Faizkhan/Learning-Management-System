...
import 'package:xirfadkaab/screen/home/widgets/best_selling_courses_content.dart';
...
class BestSellingCourseDetails extends StatelessWidget {
  const BestSellingCourseDetails({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: CustomAppBar(appBarName: 'best_selling_courses'.tr()),
      ),
