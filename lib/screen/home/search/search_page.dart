...
import 'package:xirfadkaab/screen/home/search/search_page_provider.dart';
        ...
        builder: (context, provider, _) {
          return Scaffold(
            appBar: PreferredSize(
              ...
              child: CustomAppBar(appBarName: 'search'.tr()),
            ),
                    ...
                    provider.searchPageResponse?.data?.isEmpty == true
                        ...
                        : SizedBox(
                            child: ListView.builder(
                              shrinkWrap: true,
                              itemCount:
                                  provider.searchPageResponse?.data?.length ??
                                      0,
                              physics: const NeverScrollableScrollPhysics(),
                              itemBuilder: (context, index) {
                                final data =
                                    provider.searchPageResponse?.data?[index];
