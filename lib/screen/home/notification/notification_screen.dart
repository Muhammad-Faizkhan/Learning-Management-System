...
import 'package:xirfadkaab/screen/home/notification/notification_provider.dart';
        ...
        builder: (context, provider, _) {
          return Scaffold(
            appBar: PreferredSize(
              ...
              child: CustomAppBar(appBarName: 'notification'.tr()),
            ),
            body: provider.notificationResponse?.data?.notifications?.isEmpty ??
                ...
                : ListView.builder(
                    itemCount: provider.notificationResponse?.data
                            ?.notifications?.length ??
                        0,
                    itemBuilder: (context, index) {
                      final data = provider
                          .notificationResponse?.data?.notifications?[index];
                      return Column(
                        children: [
                          Padding(
