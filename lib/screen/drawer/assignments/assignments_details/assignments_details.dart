        ...
        builder: (context, provider, _) {
          return Scaffold(
            appBar: PreferredSize(
              ...
              child: const CustomAppBar(appBarName: 'assignments_details'),
            ),
            body: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  provider.assignmentResponse?.data?.assignment?.file != null
                      ...
                      : Center(
                          child: CustomText(
                            text: 'not_submitted_assignment_yet'.tr(),
                            fontSize: 12.sp,
                            fontWeight: FontWeight.w600,
                            color: AppColors.title,
                          ),
...
class UploadAssignmentCart extends StatelessWidget {
  ...
  const UploadAssignmentCart({super.key, this.image, this.title});
