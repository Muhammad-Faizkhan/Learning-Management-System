...
class AssignmentCart extends StatelessWidget {
  ...
  const AssignmentCart({super.key, this.profileResponse});
...
class AssignmentListCart extends StatelessWidget {
  ...
  const AssignmentListCart({super.key, this.assignmentType});
